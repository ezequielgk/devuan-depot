...
DEPS="python3, python3-gi, gir1.2-gtk-4.0, gir1.2-adw-1, python3-requests, squashfs-tools, dconf-gsettings-backend | gsettings-backend"
...
mv "gearlever_${VERSION}_all.deb" ..
